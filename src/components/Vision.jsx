...
export const Vision = () => {
  ...
  `,
        ...
        overflow: "hidden",
      }} className="relative py-24 px-6 text-center bg-[#0a0a0a] text-white overflow-hidden">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            {/* Worship */}
            <div className="bg-slate-50 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition duration-500">
